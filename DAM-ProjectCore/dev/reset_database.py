...
import db
import settings
from db.models import SQLAlchemyBase, User, GenereEnum, UserToken, Carta, Baraja, Juego
...
if __name__ == "__main__":
    ...
    db_session.add(juego2)
    
    db_session.add(baraja)
    db_session.add(carta1)
    db_session.add(carta2)
